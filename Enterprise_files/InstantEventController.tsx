...
export default function InstantEventController({
  ...
  // ENTERPRISE FEATURES BYPASS: Allow instant booking when enterprise features are enabled
  ...
  return (
    <LicenseRequired>
      <div className="block items-start sm:flex">
        {/* ENTERPRISE FEATURES BYPASS: Show instant booking UI when enterprise features enabled */}
